...
<tiles:insertDefinition name="defaultLayout">
    <tiles:putAttribute name="main">
        <div id="rightContent">
        	...
        	<tr>
        		<th><h3>USER</h3></th>
        		<td style="padding-left: 700px;font-weight: bold;font-size: 13">Search: <input type="text" name="searchUser" value='<s:property value="searchUser"/>'> </td>
        	</tr>
        	<tr>	
        		<th>
        			<td style="padding-left: 750px;font-weight: bold;font-size: 13">
                                 <button name="submitType" value="searchUser" type="submit">Search</button>
        	...
        	<tr>
        		<th>
        			<td style="padding-left: 750px;color: red; font-weight: bold;"><s:property value="msg"/></td>
        		 </th>
        	</tr>	      		         	
        	</s:form>
           <div class="sukses">
               <s:form action="addUser" method="post"  style="align:center">
                    <table>
                        ...
                        <td style="color: green;font-weight: bold;font-size: 16"><s:if test="hasActionMessages()">
                			...
                			<th><span style="color:red;"><s:property value="smg"/></span></th>
                        </tr>
                     </table>
               </s:form> 
               <div>
